...
async def test_start_conversation():
    ...
    interviewer = """Assume you are a researcher and will conduct a cognition test.
    ...
    response = await pytest.multihead.start_conversation(
...
async def test_continue_conversation():
    response = await pytest.multihead.continue_conversation()
